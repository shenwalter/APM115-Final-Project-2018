...
prd = i*(1/n); % College's RD acceptance rate
...
xlabel('{Prop. of students p_{rd} admitted RD}');
ylabel('{Prop. of students p}');
title({'{\bf\fontsize{14} States 1-3 Prop. vs. Prop. of students p_{rd} admitted RD}'; 'p_{ed}=0.4, y=0.35'},'FontWeight','Normal');